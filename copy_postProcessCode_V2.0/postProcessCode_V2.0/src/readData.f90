...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine readpoddata(iplane,x0,lsmlim,ireyst,icorl,var1,var2,j0,k0,inst)
  implicit none
  integer,intent(out)::iplane,x0,lsmlim,ireyst,inst
  integer,intent(out)::icorl,var1,var2,j0,k0
  open(12,file='poddata.dat')
  read(12,*)iplane,x0,lsmlim,ireyst,inst
